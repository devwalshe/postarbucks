...
let local = 'https://383kqq-1234.csb.app/api/coredrinks'
...
async function allcustom(){
    try{
        const response = await fetch('https://383kqq-1234.csb.app/api/allnames')
        const data = await response.json()
        console.log(data)
    }
    catch{
...
dynamicURL()
if(production === 'dev'){
    localStorage.setItem('LastClicked',["https://383kqq-1234.csb.app/api/customizations",local,'https://383kqq-1234.csb.app/api/customers','https://localhost:8000/order'])
    removeAllChildNodes(document.querySelector('.items'))
    removeAllChildNodes(document.querySelector('.drinkType'))
    apiRequestForCustomizations("https://383kqq-1234.csb.app/api/customizations")
    apiRequest(local)
    apiRequestCustomer('https://383kqq-1234.csb.app/api/customers')
    postUrl ='https://383kqq-1234.csb.app/order'
}else
if(production=== 'live'){
